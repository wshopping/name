...
class Buyer(models.Model):
    ...
    photo = models.ImageField(upload_to = "buyyer/images",blank = True,null = True)
...
class Order(models.Model):
    ...
    order_statue=models.CharField(max_length=32)# 状态 未支付 配送中
    total=models.FloatField()#订单总价

    user =models.ForeignKey(Buyer,on_delete=True)#用户
    order_address =models.ForeignKey(Address,on_delete=True)#地址 外键
